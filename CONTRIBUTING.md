...
```bash
git clone https://github.com/coleam00/beiengAI.online-any-llm.git
```
...
```bash
# Development
docker run -p 5173:5173 --env-file .env.local beiengai-ai:development

# Production
docker run -p 5173:5173 --env-file .env.local beiengai-ai:production
```
