  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-beiengai-elements-item-contentDefault hover:text-beiengai-elements-item-contentActive hover:bg-beiengai-elements-item-backgroundActive':
          !selected,
        'bg-beiengai-elements-item-backgroundAccent text-beiengai-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-beiengai-elements-item-backgroundActive text-beiengai-elements-item-contentDefault': !selected,
        'bg-beiengai-elements-item-backgroundAccent text-beiengai-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-beiengai-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
